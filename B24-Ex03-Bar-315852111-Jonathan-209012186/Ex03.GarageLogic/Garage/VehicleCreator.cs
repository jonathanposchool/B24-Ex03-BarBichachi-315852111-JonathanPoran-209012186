...
internal static class VehicleCreator
{
    ...
    internal static Truck CreateNewTruck(string i_LicenseNumber, string i_Model, eVehicleTypes i_TruckType, float i_EnergyAvailable, string i_TireManufacturer, float i_TireAirPressure, bool i_IsCarryingHazardousMaterials, float i_CargoVolume)
    {
